...
def update_graph(selector):
    options_data = {
        ...
        'Acousticness': go.Scatter(x=df.acousticness, y=df.popularity, mode='markers', name='Acousticness'),
        'Liveness': go.Scatter(x=df.liveness, y=df.popularity, mode='markers', name='Liveness'),
        'Energy': go.Scatter(x=df.energy, y=df.popularity, mode='markers', name='Energy'),
        'Valence': go.Scatter(x=df.valence, y=df.popularity, mode='markers', name='Valence')
    }
